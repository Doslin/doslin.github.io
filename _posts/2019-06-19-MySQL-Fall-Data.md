...
![image-20190620140817221](https://res.cloudinary.com/dvu6persj/image/upload/v1561015928/Blog/MySQL/3251561010697_.pic.png)
...
![3241561010369_.pic](https://res.cloudinary.com/dvu6persj/image/upload/v1561015933/Blog/MySQL/3241561010369_.pic.png)若建索引的字段不是主键ID，则对该字段建索引，然后在叶子节点中存储的是该记录的主键，然后通过主键索引找到对应的记录。
